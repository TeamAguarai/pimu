...
public:
    /* Imu constructor */
    Imu(MPU9250 &module) : module_(module), gyro_(module), accel_(module) {}
    ...
    void print(MultiSensor read_data) {
        std::cout << "Gyro (x, y, z): " << read_data.gx << "rad/s, " << read_data.gy << "rad/s, " << read_data.gz << "rad/s\n";
        std::cout << "Accel (x, y, z): " << read_data.ax << "G, " << read_data.ay << "G, " << read_data.az << "G\n";
    }
