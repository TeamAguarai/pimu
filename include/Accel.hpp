...
{
public:
    Accel(MPU9250 &module) : module_(module) {}
    ...
    /* prints the accelerometer readings in a formatted output. */
    Sensor read() {
        Sensor return_data;
    ...
    /* updates angles made from the X and Y axis */
    void updateAngles() {
        Sensor reading = read();
